...
\begin{enumerate}
   ...
   These new probabilities are used to calculate the estimated treatment effect under the incorrect causal graph in Figure \ref{fig:IND_GRAPH}.
   ...
   This effects the full result of applying the intervention, as with a total treatment effect estimator.
   ...
   These probabilities are used to calculate the estimated treatment effect under the correct causal graph in Figure \ref{fig:DA_causal_2}.
