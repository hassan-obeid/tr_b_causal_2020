...
The goal of our simulation exercise is to show that ignoring the true generative model of the data would result in arbitrarily biased treatment effects, even if the analyst knows the true outcome model.
