...
Then, we list all the variables we believe to influence the variable(s) of interest.
...
At this point, we have added all the outcome, explanatory, effect modifying, mediating, confounding, and time-indexed variables that we believe are relevant to our context to our causal graph.
However, they are all disconnected nodes, singletons, in the graph.
