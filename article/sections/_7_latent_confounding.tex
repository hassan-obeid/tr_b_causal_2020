...
algorithm by Wang et al. (2019). The method attempts to control for the 
...
We estimate three models:
	...
	with the approach taken in Wang et. al (2019), where they use all the set 
...
recovery of the true confounder. Figures bla and bla show a QQ plot of the true 
and recovered confounders under method 2 and 3 respoectively. Looking at those 
...
observed covariates. Please refer to section 4 {ref} for how to build and test 
plausible causal graphs. 
...
confounder variable, but with some white, random normal noise. Figure bla
