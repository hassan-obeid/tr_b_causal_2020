...
We might then wish to treat the coefficient on this variable as the causal effect of adding a bikelane on the log-odds of choosing to bike.
...
being environmentally friendly may both affect whether she chooses to bike to
work, as well as whether she lives close to bike infrastructure.
Failing to account for these attitudes may bias our observational study
