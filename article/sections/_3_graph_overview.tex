...
An example of such ICLV models is in Figure \ref{}, based on Figure 5 of \citet{ben_2002_integration}.
...
% \begin{figure}
% \centering
% \includegraphics[width=0.5\textwidth]{activity-based-model-causal-graph}
