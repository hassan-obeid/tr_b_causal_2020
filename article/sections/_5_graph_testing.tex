...
We can make use of so-called ``triad constraints'' that test independence between ``pseudo-residual'' values and one's explanatory variables \citep{cai_2019_triad}.
Results from tests of triad-constraints are particularly useful for testing assumptions about how unobserved variables in our graph relate to each other and to our observed variables.
