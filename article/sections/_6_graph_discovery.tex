...
Finally, to complement this sub-section's discussion about using existing experimental data, see Section \ref{sec:discussion-experimentation}.
...
In essence, we discuss planning experiments to get the data we need, as opposed to merely doing our best with the data we have.
