...
# Estimate Causal Effects - Independently Generated Variables


## Compute Initial Probabilities Using Estimated Model on Simulated Data

```python
initial_probabilities = mnl_model_sim.predict(long_sim_data)
```

## Disturb X Independently
...
## Compute Naive Probabilities Using Disturbed data and Estimated Model on Simulated Data
