...
- For each of for statements under the FindLongDataDist function, the logic should be written in a function.
...
# 0. Code for Documentation Purposes
...
## 0.4. Simulate Data - Based on Wide Data - For Documentation Purposes
