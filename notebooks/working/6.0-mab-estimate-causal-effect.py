...
#                                                                    size = long_sim_data_causal.loc[long_sim_data_causal['mode_id']==1].shape[0]))
    ...
    long_sim_data_causal.loc[long_sim_data_causal['mode_id'] == 1,'total_travel_time'] =\
        lin_reg_pred(long_sim_data_causal.loc[long_sim_data_causal['mode_id'] == 1,'total_travel_distance'],
                     drive_alone_reg['total_travel_time_on_total_travel_distance'],
                     sim_size=long_sim_data_causal.loc[long_sim_data_causal['mode_id'] == 1].shape[0])
    ...
    long_sim_data_causal.loc[long_sim_data_causal['mode_id'] == 2,'total_travel_time'] =\
        lin_reg_pred(long_sim_data_causal.loc[long_sim_data_causal['mode_id'] == 2,'total_travel_distance'],
                     shared_2_reg['total_travel_time_on_total_travel_distance'],
                     sim_size=long_sim_data_causal.loc[long_sim_data_causal['mode_id'] == 2].shape[0])
...
for number in sim_number:
    ...
    naive_effect = naive_data.loc[naive_data['mode_id'].isin([1,2,3]),'naive_probabilities'] - initial_data.loc[initial_data['mode_id'].isin([1,2,3]),'init_mnl_model_sim_probs']
    estimated_effect = causal_data.loc[causal_data['mode_id'].isin([1,2,3]),'estimated_probabilities'] - initial_data.loc[initial_data['mode_id'].isin([1,2,3]),'init_mnl_model_sim_probs']
    true_effect = causal_data.loc[causal_data['mode_id'].isin([1,2,3]),'true_probabilities'] - initial_data.loc[initial_data['mode_id'].isin([1,2,3]),'init_mnl_model_probs']
