    ...
    for ind in ind_spec:
        ...
        if var_types[ind] in ['categorical', 'numerical']:
            if len(ind_var.unique()) == 1:
                params_dict.setdefault('sociodemographics', {}).setdefault(ind,{})['distribution'] = 'constant'
                params_dict.setdefault('sociodemographics', {}).setdefault(ind,{})['parameters'] = ind_var.unique()
            else:
                params_dict.setdefault('sociodemographics', {}).setdefault(ind,{})['distribution'] = 'categorical'
                np_array_range = np.arange(ind_var.max()+1)
                array_bincount = np.bincount(ind_var)
                probs = array_bincount / len(ind_var)
                params_dict.setdefault('sociodemographics', {}).setdefault(ind,{})['parameters'] = [np_array_range,
                                                  probs]
        else:
            if len(ind_var.unique()) == 1:
                params_dict.setdefault('sociodemographics', {}).setdefault(ind,{})['distribution'] = 'constant'
                ...
                fitter_object.fit()
                BestDict = fitter_object.get_best()
                params_dict.setdefault('sociodemographics', {}).setdefault(ind,{})['distribution'] = list(BestDict.items())[0][0]
                params_dict.setdefault('sociodemographics', {}).setdefault(ind,{})['parameters'] = list(BestDict.items())[0][1]
        ...
        for var in alt_spec_dic[alt]:
            if var_types[var] == 'empirical':
                if len(mode_data[var].unique()) == 1:
                    params_dict.setdefault(alt_name_dic[alt], {}).setdefault(var, {})['distribution'] = 'constant'
                    params_dict.setdefault(alt_name_dic[alt], {}).setdefault(var, {})['parameters'] = mode_data[var].unique()
                else:
                    params_dict.setdefault(alt_name_dic[alt], {}).setdefault(var, {})['distribution'] = 'empirical'
                    params_dict.setdefault(alt_name_dic[alt], {}).setdefault(var, {})['parameters'] = np.array(mode_data[var])
            elif var_types[var] == 'categorical':
                if len(mode_data[var].unique()) == 1:
                    params_dict.setdefault(alt_name_dic[alt], {}).setdefault(var, {})['distribution'] = 'constant'
                    params_dict.setdefault(alt_name_dic[alt], {}).setdefault(var, {})['parameters'] = mode_data[var].unique()
                else:
                    params_dict.setdefault(alt_name_dic[alt], {}).setdefault(var, {})['distribution'] = 'categorical'
                    ...
                    params_dict.setdefault(alt_name_dic[alt], {}).setdefault(var, {})['parameters'] = [np_array_range,
                                                                            probs]
            else:
                if len(mode_data[var].unique()) == 1:
                    params_dict.setdefault(alt_name_dic[alt], {}).setdefault(var, {})['distribution'] = 'constant'
                    ...
                    fitter_object.fit()
                    BestDict = fitter_object.get_best()
                    params_dict.setdefault(alt_name_dic[alt], {}).setdefault(var, {})['distribution'] = list(BestDict.items())[0][0]
                    params_dict.setdefault(alt_name_dic[alt], {}).setdefault(var, {})['parameters'] = list(BestDict.items())[0][1]
    ...
    for var in trip_spec:
        ...
        if var_types[var] == 'empirical':
            if trip_var.unique() == 1:
                ...
                params_dict.setdefault(alt_name_dic[alt], {}).setdefault(var, {})['distribution'] = 'empirical'
                params_dict.setdefault(alt_name_dic[alt], {}).setdefault(var, {})['parameters'] = np.array(trip_var)
        elif var_types[var] == 'categorical':
...
```python
def fit_regressions(regressions, reg_types, data):
...
```python
np.array(drive_alone_df['total_travel_time'])
```
