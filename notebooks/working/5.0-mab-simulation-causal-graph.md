...
```python
Shared_WTW_Df = bike_data_long[bike_data_long['mode_id']==4]
Shared_WTW_Df.reset_index(drop=True,inplace=True)
Shared_WTW_Reg = FitAlternativeRegression(regressions={1:('total_travel_time','total_travel_cost')},
                                           reg_types={1:'linear'},
                                           data = Shared_WTW_Df)
```
...
```python
Shared_DTW_Df = bike_data_long[bike_data_long['mode_id']==5]
Shared_DTW_Df.reset_index(drop=True,inplace=True)
Shared_DTW_Reg = FitAlternativeRegression(regressions={1:('total_travel_time','total_travel_cost')},
                                           reg_types={1:'linear'},
                                           data = Shared_DTW_Df)
```
...
```python
Shared_WTD_Df = bike_data_long[bike_data_long['mode_id']==6]
Shared_WTD_Df.reset_index(drop=True,inplace=True)
Shared_WTD_Reg = FitAlternativeRegression(regressions={1:('total_travel_time','total_travel_cost')},
                                           reg_types={1:'linear'},
                                           data = Shared_WTD_Df)
```
...
```python
bike_data_no_parent = SimNodeNoParent(bike_data_params, size=4000)
```
...
```python
Drive_Alone_Model.sample(n_samples=4000)
```
