...
# Walk-Transit-Walk
NODES_WTW = ["Total Travel Time", "Total Travel Cost", "Utility (WTW)"]
...
# Drive-Transit-Walk
NODES_DTW = ["Total Travel Time", "Total Travel Cost", "Utility (DTW)"]
...
# Walk-Transit-Drive
NODES_WTD = ["Total Travel Time", "Total Travel Cost", "Utility (WTD)"]
...
# Walk
NODES_WALK = ["Total Travel Distance", "Utility (Walk)"]
...
# Bike
NODES_BIKE = ["Total Travel Distance", "Utility (Bike)"]
